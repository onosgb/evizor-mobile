...
class _SymptomInputScreenState extends ConsumerState<SymptomInputScreen> {
  ...
  void _loadUserMetrics() {
    // Use WidgetsBinding to ensure providers are accessible after build start
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_selectedSymptomIds.isNotEmpty) ...[
                        ...
                        const SizedBox(height: 12),
                        ..._selectedSymptomIds.map((id) {
                          final symptom = symptoms.firstWhere(
                            (s) => s.id == id,
                            orElse: () => symptoms.first,
                          );
                          final severity = _symptomSeverities[id] ?? 5;
                      ...
                      CustomTextField(
                        label: 'Weight (kg)',
                        hint: 'Enter your weight (optional)',
                          ...
                          return CustomButton(
                            ...
                            onPressed: appointmentState.isLoading
                                ...
                                : () async {
                                    ...
                                    final symptomSeverities =
                                        _selectedSymptomIds.map((id) {
                                          return SymptomSeverity(
                                            symptomId: id,
                                            severity:
                                                _symptomSeverities[id] ?? 5,
                                          );
                                        }).toList();
