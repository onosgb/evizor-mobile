...
class UserNotifier extends AsyncNotifier<User?> {
  ...
  Future<void> fetchProfile() async {
    try {
      ...
      await storageService.saveProfileCompletionStatus(user.hasFullProfile);
  ...
  Future<void> updateProfile(UpdateProfileRequest request) async {
    try {
      ...
      await storageService.saveProfileCompletionStatus(
        updatedUser.hasFullProfile,
      );
  ...
  Future<void> uploadProfilePicture(String filePath) async {
    try {
      ...
      final url = await authService.uploadProfilePicture(filePath);
